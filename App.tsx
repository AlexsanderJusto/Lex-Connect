...
import { Search, MapPin, Filter, Send, Sparkles, Phone, Mail, Award, GraduationCap, Clock, MessageCircle, User, MessageSquare, Gavel, Scale } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-28 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-left z-10">
            ...
            <p className="text-lg md:text-xl text-legal-100 mb-10 max-w-lg leading-relaxed font-light">
              Encontre os advogados mais qualificados do Brasil ou obtenha orientação instantânea com nossa IA especializada. Personalizado para sua localização e caso.
            </p>
  ...
  const AIAgentPage = () => {
    ...
    const handleSend = async () => {
      ...
      try {
        ...
        setHistory(prev => [...prev, { role: 'model', content: "Desculpe, encontrei um erro. Por favor, tente novamente." }]);
      } finally {
        setLoading(false);
      }
    };
